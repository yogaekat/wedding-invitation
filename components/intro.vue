<template>
    <section class="h-full bg-black flex flex-col items-center justify-center snap-start bg-opacity-60 relative">
        <img src="/public/images/intro.webp" alt="" class="absolute top-0 left-0 w-full h-full object-cover z-[1]">
        <div class="absolute bottom-0 left-0 w-full flex flex-col items-center justify-center z-[2] text-white pb-6 pt-[5rem] bg-[linear-gradient(0deg,rgba(0,0,0,1)_0%,rgba(0,0,0,0.75)_58%,rgba(37,37,37,0)_100%)]">
            ...
            <div class="text-center pb-5">
                ...
                <p class="text-[3rem] font-title">Dita & Mita</p>
