       ...
       <div class="relative flex justify-center items-center h-screen overflow-hidden transition-all duration-500"  :class="isOpen ? 'w-full xl:w-2/6 xl:z-50' : 'w-full xl:w-0 xl:z-50'">
          <div class="relative z-30 w-full h-screen overflow-y-scroll snap-y snap-mandatory scroll-smooth hide-scrollbar">
                ...
                <section class="h-screen bg-green-500 flex flex-col items-center justify-center snap-center bg-opacity-60 relative">
                  ...
                  <div class="absolute bottom-0 left-0 w-full flex flex-col items-center justify-center z-[2] text-white pb-6 pt-[5rem] bg-[linear-gradient(0deg,rgba(0,0,0,1)_0%,rgba(0,0,0,0.75)_58%,rgba(37,37,37,0)_100%)]">
                        <div class="text-center pb-10">
                            <p class="text-[2rem] font-title">Putu Oka Difananda</p>
                            <span class="w-[50%] h-[1px] block bg-lightgold mx-auto my-3"></span>
                            <p class="font-primary text-[.9rem] font-light">Putra Pertama Bapak I Gede Ardiasa<br>dan Ni Ketut Artini</p>
                ...
                <section class="h-screen bg-green-500 flex flex-col items-center justify-center snap-center bg-opacity-60">
               ...
               <section class="h-screen bg-red-500 flex flex-col items-center justify-center snap-center bg-opacity-60"></section>
               <section class="h-screen bg-blue-500 flex flex-col items-center justify-center snap-center bg-opacity-60"></section>
