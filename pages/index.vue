<template>
    ...
    <div class="fixed left-0 w-full h-[100dvh] bg-[#252525] z-40 flex justify-center items-center xl:hidden transition-all duration-1000" :class="isOpen ? '-top-[100%]' : 'top-0'">
        ...
        <div class="absolute top-0 left-0 h-full w-full flex justify-center items-end pb-[3rem] z-[2] bg-[linear-gradient(0deg,rgba(37,37,37,1)_0%,rgb(37_37_37_/_19%)_50%,rgb(0_0_0_/_0%)_100%)]">
            <div class="flex flex-col items-center transition-all duration-700 font-primary">
                <img src="/public/images/logo.svg" alt="" class="h-[15dvh] mb-2">
                <transition
    ...
    <div class="flex relative ">
       <div class="bg-[#252525] xl:flex xl:flex-col items-center justify-center z-40 relative hidden transition-all duration-500" :class="isOpen ? 'xl:w-4/6' : 'xl:w-full'">
            <img src="/public/images/cover.webp" alt="" class="h-full w-full object-cover object-[0px_69%] absolute top-0 left-0 z-[1]">
            <div class="absolute top-0 left-0 h-full w-full bg-[#252525]/80 flex justify-center items-end pb-[5rem] z-[2]">
                <div class="flex flex-col items-center transition-all duration-700 font-primary">
                    <img src="/public/images/logo.svg" alt="" class="h-[20vh] mb-5" data-aos="fade-up">
                    <transition
                      enter-active-class="transition-all duration-700 ease-in-out"
                      enter-from-class="opacity-0 max-h-0"
                      enter-to-class="opacity-100 max-h-20"
